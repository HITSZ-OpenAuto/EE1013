...
包含《电路理论基础》前四章，《模拟电子技术基础》第一章、第四章滤波器部分、第五章、第六章、第七章，和《数字电子技术基础》第一、二章、第四章、第五章触发器部分、第六章、第八章。电路前四章未做删减，模电、数电均有一定程度的删减，以教学大纲为准。
...
电路部分老师包括wy,wc,zf,sl；模电部分老师包括wlx,gy；数电部分老师包括ll,wlx,pxw,yjc；三个部分的老师可以分别参考原《电路IA》《电路IB》《模拟电子电路基础》《数字电子电路基础》对应老师的评价。电路的wc、zf，模电的gy，数电的ll的授课仍然非常值得去听。

> 文 / [Gaster](https://github.com/WDGaster703), 2024.12

## 关于考试

考试由电路、模电、数电题目组合而成，分数占比分别为4:3:3，题型为填空题和计算题，其中计算题3题电路，2题模电，2题数电，填空题4题电路，2题数电，模电则有10个空的基本概念填空。
23级的考试计算量很大，且考试需要会使用计算器计算相量，考试时注意时间安排。
...
电路部分学有余力建议学点频率响应（第七章）和暂态电路（第八、九章）的内容，在模电中有要求但是学时没有安排。电路和数电总体还是按体系讲的，可以跟着教学计划学习，学有余力可以自学跳过的内容。模电拆的七零八落的，建议跟着上交大zzy或者清华hcy对模电整本书进行初步的学习，至少对分立元件的电路有一点基本的认知。
